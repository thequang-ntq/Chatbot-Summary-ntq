//This is the code file for the menu drawer that contains history in Summarize Screen
//The function this.toRefresh define the progress when you press a new summary, history or
//delete a history then the menu drawer will pop out, and summarize screen will be refreshed
        ...
        children: [
          Row(
            ...
            children: [
              ...
              TextButton(
                //New summarize text button which do the same thing as add new summary button
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: TextButton(
                                  //Text of the title of the summarize, click it will reload the history
                                  child: AutoSizeText(
                                    chatMessage['text'], 
